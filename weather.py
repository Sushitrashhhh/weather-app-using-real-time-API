...
class WeatherApp(QWidget):
    ...
    def get_weather(self):
        ...
        url = f"https://api.openweathermap.org/data/2.5/weather?q={city}&appid={api_key}" #THE URL TO FETCH THE DATA
        ...
        try:
            ...
            match response.status_code:
                case 400:
                    self.display_error("Bad!!! Very Bad!!! Request\nPlease check your input")
                case 401:
                ...
                case 500:
                    self.display_error("Internal Server Error\nPlease visit late. APPLICATION UNDER MAINTAINANCE")
                case 502:
                    self.display_error("Bad Gateway\nInvalid response from the server")
                case 503:
                    self.display_error("Service Unavailabel\nServer is too high to send info")
                case 504:
